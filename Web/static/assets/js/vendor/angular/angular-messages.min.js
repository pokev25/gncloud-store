...
(function (z, l) {
        ...
        return ["$animate", function (t) {
            return {
                ...
                link: function (p, n, a, c, f) {
                    var e = n[0], d, q = a.ngMessage || a.when;
                    a = a.ngMessageExp || a.whenExp;
                    var k = function (a) {
                        d = a ? x(a) ? a : a.split(/[\s,]+/) : null;
                        c.reRender()
                    };
                    a ? (k(p.$eval(a)), p.$watchCollection(a, k)) : k(q);
                    var g, r;
                    c.register(e, r = {
                        test: function (a) {
                            var m = d;
                            a = m ? x(m) ? 0 <= m.indexOf(a) : m.hasOwnProperty(a) : void 0;
                            return a
                        }, attach: function () {
                            g || f(function (a,
                                             m) {
                                ...
                                g.on("$destroy", function () {
                                    g && g.$$attachId === d && (c.deregister(e), r.detach());
                                    m.$destroy()
                                })
                            })
                        }, detach: function () {
    ...
    l.module("ngMessages", []).directive("ngMessages", ["$animate", function (t) {
        function p(a, c) {
        ...
        return {
            require: "ngMessages", restrict: "AE", controller: ["$element", "$scope",
                "$attrs", function (a, c, f) {
                    ...
                    var g = this.messages = {}, r, l;
                    this.render = function (m) {
                        m = m || {};
                        r = !1;
                        l = m;
                        for (var g = p(c, f.ngMessagesMultiple) || p(c, f.multiple), b = [], e = {}, h = d.head, q = !1, k = 0; null != h;) {
                            k++;
                            var s =
                                h.message, v = !1;
                            q || u(m, function (a, b) {
